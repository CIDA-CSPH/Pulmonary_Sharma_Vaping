...
#write_csv(full_results, here("DataProcessed/methylation/results/full_res_bacon_2022_12_01.csv"))

#write_csv(noCenter_results, here("DataProcessed/methylation/results/noCenter_res_2022_12_01.csv"))
