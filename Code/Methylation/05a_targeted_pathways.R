## ---------------------------
## Script name: Targeted Methylation (Specific Pathways)
##
## Purpose of script: Redo Targeted Methylation Analysis with more targeted gene set
##
...
writexl::write_xlsx(list_of_datasets, here("DataProcessed/methylation/results/targeted/targetedDMPpathways_results_reporting_2023_01_26.xlsx"))
