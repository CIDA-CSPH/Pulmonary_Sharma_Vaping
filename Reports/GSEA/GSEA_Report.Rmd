...
Only pathways with $\ge 2$ ENTREZ genes were considered for GSEA. After the initial analysis, we determined *statistically* independent pathways using the function `collapsePathways` from `fGSEA`.
