...
#import data
tab1_dat <- read_csv(here("DataProcessed/clinical_metadata/table1_clean_data_2022_08_22.csv"))
...
######################### Read in Results ###############################
vape_center_res <- read_csv(here("DataProcessed/rna_seq/differential_expression/full_analysis/vape_center_res_2022_05_01.csv"))
vape_res <- read_csv(here("DataProcessed/rna_seq/differential_expression/full_analysis/full_vape_res_2022_05_01.csv"))
center_res <- read_csv(here("DataProcessed/rna_seq/differential_expression/full_analysis/center_res_2022_05_01.csv"))

#Read in log-normalized counts (See 04_DESeq2_DE_Model_fit.R)
vape_center_counts <- read_csv(here("DataProcessed/rna_seq/differential_expression/full_analysis/vape_center_ruv_normcounts_2022_05_06.csv"))
vape_counts <- read_csv(here("DataProcessed/rna_seq/differential_expression/full_analysis/vape_ruv_normcounts_2022_05_06.csv"))
center_counts <- read_csv(here("DataProcessed/rna_seq/differential_expression/full_analysis/center_ruv_normcounts_2022_05_06.csv"))
ruv_counts <- read_csv(here("DataProcessed/rna_seq/ruv/RUV_k2_norm_counts_2022_05_06.csv"))
