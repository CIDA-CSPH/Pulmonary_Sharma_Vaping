...
To additionally check model results, Figures 6 - 8 box plots compare $\log_{2}$ transformed expression of the top 4 genes for each model as indicated by the smallest FDR.  

### Figures 6: $\log_{2}$(Normalized Expression) of Top Genes (Vape Status and Center)
...
### Figure 7: $\log_{2}$(Normalized Expression) of Top Genes (Vape Status Only)
```{r, fig.width= 10, fig.height= 8}
...
### Figure 8: $\log_{2}$(Normalized Expression) of Top Genes (Center Only)
```{r fig.width= 10, fig.height= 8}  
...
### Figure 9: $\log_{2}$(RUV-Normalized) expression for comparison
```{r fig.width= 10, fig.height= 8}
