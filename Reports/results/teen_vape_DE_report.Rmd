...
### Figures 6: $\log_2$ Expression of Top Genes (Vape Status and Center)
...
### Figure 7: $\log_2$ Expression of Top Genes (Vape Status Only)
```{r, fig.width= 10, fig.height= 8}
...
### Figure 8: $\log_2$ Expression of Top Genes (Center Only)
```{r fig.width= 10, fig.height= 8}  
...
### Figure 9: RUV-normalized expression for comparison
```{r fig.width= 10, fig.height= 8}
