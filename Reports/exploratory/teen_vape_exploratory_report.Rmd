...
Figure 1 visualizes the demographic information presented in Table 1. The majority of vaping subjects were recruited in Pueblo (92%) and identified as LatinX (85%). `r format_num(p_male)`% of subjects were male as confirmed from the available methylation data.
