...
The previous version of this report did **not** include BMIQ normalization, but this report will to address the concern for insufficient within-array normalization. BMIQ works in conjunction with noob to correct type II probe bias [@liu2016].
...
![](dyebias_plot_noob_bmiq_2022_09_09.jpeg)
...
The previous version of this report ("Methylation_QC_2022_09_08.html") saw no clustering by vape status. After the addition of 'BMIQ' normalization, there may be some weak clustering by vape status.

### Figure 8: Sample Clustering (Recruitment Center)

```{r fig.height=8, fig.width=12}
make_mds_plots(betas, metadata_sex, plot = "center", nump = 1000)
make_mds_plots(betas, metadata_sex, plot = "center", nump = 10000, lim = c(-100, 100), mlim = c(-100, 100))
```
